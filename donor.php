...
?>
  ...
  <button type="button" class="btn btn-default bg-primary" data-toggle="modal" data-target="#chariyal-modal"><i class="fa fa-plus"></i> Add New</button>
   ...
   <table id="example1" class="table table-bordered table-striped">
    ...
    <?php
    $count=0;
       $readquery=mysqli_query($conection,"SELECT bd.ID ID, bd.name PersonName, bd.Address,bd.Phone,bd.Age as Age,bd.RegDate as RegDate,bd.Status as Status,b.name AS 'BloodType' FROM blooddonor bd LEFT JOIN blood b ON b.ID = bd.BloodType");
